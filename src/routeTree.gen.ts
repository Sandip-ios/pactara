...
import { Route as DevWelcomeRouteImport } from './routes/dev-welcome'
...
const DevWelcomeRoute = DevWelcomeRouteImport.update({
  id: '/dev-welcome',
  path: '/dev-welcome',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/dev-welcome': typeof DevWelcomeRoute
...
export interface RootRouteChildren {
  ...
  DevWelcomeRoute: typeof DevWelcomeRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/dev-welcome': {
      id: '/dev-welcome'
      path: '/dev-welcome'
      fullPath: '/dev-welcome'
      preLoaderRoute: typeof DevWelcomeRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/badge-preview': {
      id: '/badge-preview'
...
const rootRouteChildren: RootRouteChildren = {
  ...
  DevWelcomeRoute: DevWelcomeRoute,
