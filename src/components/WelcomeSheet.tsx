...
export function WelcomeSheet({ firstName, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[70]" style={{ fontFamily: "Inter, system-ui, sans-serif" }}>
      ...
      <div className="absolute inset-x-0 bottom-0 w-full bg-[#F5F2EE] rounded-t-3xl pt-3 pb-sheet px-6 max-h-[92dvh] overflow-y-auto animate-in slide-in-from-bottom duration-300">
