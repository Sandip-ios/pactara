  ...
  return (
    <div className="fixed inset-0 z-[80]" style={{ fontFamily: JAKARTA }}>
      ...
      <div
        role="dialog"
        aria-modal="true"
        className="absolute inset-x-0 bottom-0 bg-white rounded-t-[24px] pb-sheet max-h-[92vh] overflow-y-auto animate-in slide-in-from-bottom duration-200"
      >
        ...
        <div className="px-6">
          ...
          <button
            onClick={onRecord}
            className="mt-10 w-full h-14 rounded-full bg-[#111827] text-white text-[16px] font-bold active:opacity-90"
          >
            Record now
          </button>
        </div>
