...
export function BottomTabs() {
  ...
  return (
    <nav
      data-bottom-tabs
      className="fixed bottom-0 inset-x-0 z-[60] bg-white border-t border-neutral-200 px-2 pt-2 pb-[calc(env(safe-area-inset-bottom)+2px)] grid grid-cols-5 items-end"
    >
