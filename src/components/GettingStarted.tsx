    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          <div
            className="relative w-full rounded-t-3xl bg-[#FFF7E6] pt-3 pb-[env(safe-area-inset-bottom)] max-h-[85dvh] overflow-y-auto animate-in slide-in-from-bottom duration-300"
          >
