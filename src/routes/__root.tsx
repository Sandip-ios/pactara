...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Pactara" },
      { name: "description", content: "Your social fitness accountability app" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Pactara" },
      { property: "og:description", content: "Your social fitness accountability app" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Pactara" },
      { name: "twitter:description", content: "Your social fitness accountability app" },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/97804905-053e-4243-8fa2-2fa19c3a43f3/id-preview-9d89fdbc--37deba7f-b522-489e-ac22-b9f9015c4c0a.lovable.app-1782240981777.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/97804905-053e-4243-8fa2-2fa19c3a43f3/id-preview-9d89fdbc--37deba7f-b522-489e-ac22-b9f9015c4c0a.lovable.app-1782240981777.png" },
    ],
    links: [
